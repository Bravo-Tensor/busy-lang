...
2. Use CLI results for deterministic heading self-link checks. `## [ReviewProject](#reviewproject)` links a heading to itself; `Run [ReviewProject](#reviewproject)` is a valid body reference to an operation. A heading linking to the core Operation definition is also valid for this rule.
